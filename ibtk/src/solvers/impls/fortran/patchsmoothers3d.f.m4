...
c
c     Perform a single Gauss-Seidel sweep for F = alpha div grad U +
c     beta U, with spatially varying beta.
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine gssmoothvarc3d(
     &     U,U_gcw,
     &     alpha,
     &     beta,beta_gcw,
     &     F,F_gcw,
...
c
      ...
      INTEGER ilower1,iupper1
      INTEGER ilower2,iupper2
      INTEGER U_gcw,F_gcw,beta_gcw

      REAL alpha
      
      REAL beta(ilower0-beta_gcw:iupper0+beta_gcw,
     &          ilower1-beta_gcw:iupper1+beta_gcw,
     &          ilower2-beta_gcw:iupper2+beta_gcw)
...
c
      ...
      do i2 = ilower2,iupper2
         do i1 = ilower1,iupper1
            do i0 = ilower0,iupper0
               fac = 0.5d0/(fac0+fac1+fac2-0.5d0*beta(i0,i1,i2))
               U(i0,i1,i2) = fac*(
     &              fac0*(U(i0-1,i1,i2)+U(i0+1,i1,i2)) +
     &              fac1*(U(i0,i1-1,i2)+U(i0,i1+1,i2)) +
     &              fac2*(U(i0,i1,i2-1)+U(i0,i1,i2+1)) -
...
c
c     Perform a single "red" or "black" Gauss-Seidel sweep for F = alpha
c     div grad U + beta U, with spatially varying beta.
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine rbgssmoothvarc3d(
     &     U,U_gcw,
     &     alpha,
     &     beta,beta_gcw,
     &     F,F_gcw,
...
c
c     Perform a single Gauss-Seidel sweep for F = alpha div grad U +
c     beta U with masking of certain degrees of freedom, with spatially
c     varying beta.
c
c     NOTE: The solution U is unmodified at masked degrees of freedom.
c
...
c
      ...
      INTEGER ilower1,iupper1
      INTEGER ilower2,iupper2
      INTEGER U_gcw,F_gcw,mask_gcw,beta_gcw
...
c
c     Perform a single "red" or "black" Gauss-Seidel sweep for F = alpha
c     div grad U + beta U with masking of certain degrees of freedom, with
c     spatially varying beta.
c
c     NOTE: The solution U is unmodified at masked degrees of freedom.
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine rbgssmoothvarcmask3d(
     &     U,U_gcw,
     &     alpha,
     &     beta,beta_gcw,
     &     F,F_gcw,

...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
c     Computes W = strain u = 0.5*(du1/dx0 + du0/dx1).
c
c     Uses centered differences to compute the node centered stress of a
c     side centered vector field u=(u0,u1).
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine stonstrain2d(
     &     W,W_gcw,
     &     U0,U1,U_gcw,
     &     ilower0,iupper0,
     &     ilower1,iupper1,
...
c
      INTEGER i0,i1
c
c     Compute the node centered strain of U.
c

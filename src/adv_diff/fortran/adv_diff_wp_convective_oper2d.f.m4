...
c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine wave_prop_convective_oper_2d(
     &            q_data, q_gcw,
     ...
     &            smooth_weights, smooth_weights_centers, k)
      ...
      REAL interp_coefs_centers(0:k,0:(k-1))
      REAL smooth_weights_centers(0:(k-1))
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &            smooth_weights_centers, k)
       ...
       REAL weights_cell_centers(0:k,0:(k-1))
     ...
     &               (ilower0):(iupper0))
       ...
       REAL theta, new_weights_n(0:k-1), new_weights_p(0:k-1)
       REAL weights_p_2(0:k-1), weights_n_2(0:k-1)
       REAL sigma(0:1)
